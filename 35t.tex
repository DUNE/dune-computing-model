...
The external trigger paddles will be used to identify samples of cosmic rays that are particularly useful in determining
...
These two gateway nodes are also connected via a 1~GBit/sec link to the Fermilab campus network thus providing the way
...
\fxnote{calibration runs -- long events (1/3 minute) - Tom, can you improve that?}
