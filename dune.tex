...
out of a few -- the beam $\nu$ events -- produce a tiny nominal amount of data when compared to other sources.
It may be helpful then to consider adjustments to the parameters and approaches used in the criteria for data collection, such as
...
for the beam $\nu$ significantly more lax. While it will take a carefuly study to quantify the effects of various levels of zero suppression
...
%it is easier to provide networking and other services for data handling.
