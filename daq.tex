...
\end{itemize}
\fxnote{Need to reconsile the no-ZS stance here with ZS elsewhere}
...
The data are received by LArTPC data processors called RCEs \cite{slac_rce_1} (Reconfigurable
