...
contribution from atmospheric $\nu$ will be less than the smallest entry in this table (beam-$\nu$), so for sake
...
10\,s. It should be emphasized that both these parameters are subject to
...
a material effect on the volume of data which the focus here.
...
of software release and calibration data, for optimal efficiency.
