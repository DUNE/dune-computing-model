...
\ 
\\
Some basic parameters of the NDS are presented in Table~\ref{tab:nds-params}.
\begin{table}[ht!]
\centering
...
\subsection{Thresholds for the Far Detector LArTPC Data Rate Estimations}
...
% In discussion with the DAQ experts they are expected to be satisfied. More information on the DAQ is available in the Volume 4 of the CDR.
