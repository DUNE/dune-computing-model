...
\end{itemize}
\ 
In the reference design at the time of writing, the FGT) near consists of a straw-tube
...
data rate from the NDS will be in the $O(1)$\,MB per second range. More information will
be added to these estimates as the R\&D in this area progresses.

%, and effectively well below
