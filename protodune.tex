...
It is also used to provide input to Data Quality Monitoring (DQM) and other express processing streams at CERN
...
To make this possible the design calls for deployment of the necessary computing resources (equivalent to hundreds of cores)
in the data room of NP02.
...
No extensive processing is foreseen on the experiment site.
%Among the possible technical options for the buffer farm file access is XRootD.
\end{description}
