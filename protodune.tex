...
will operate two large scale Liquid Argon TPC prototypes at CERN in 2018 (for the single- and dual-phase
...
\item{\textbf{EOS}}  high-performance distributed disk storage system at CERN
\item{\textbf{F-FTS}} Fermilab File Transfer Service
\item{\textbf{NP02}} The dual-phase part of the \pd program
\item{\textbf{NP04}} The single-phase part of the \pd program
\item{\textbf{DQM}} Quality Assurance (mostly applied to the recorded data in this context)
...
\bibitem{cdr_vol4_docdb} LBNE\,DocDB\,1069  % \,\url{http://lbne2-docdb.fnal.gov/cgi-bin/DocumentDatabase/}
