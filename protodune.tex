...
EOS is also used as staging area for to Data Quality Monitoring (DQM) processing which takes place in Tier-0.
...
The CPU is provided by the so-called ``neut'' cluster provided by the CERN Neutrino Platform and located in the immediate vicinity of the NP02 detector.
...
\fxnote{Maxim - this will require perhaps a total rewrite by the NP02 team}
\ \\
