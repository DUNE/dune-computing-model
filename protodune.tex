...
We cannot begin to over emphasize the need for data processinbg and quality monitoring coupled with automating system configurations
and remote monitoring of the cluster. To achieve these, a software stack has been chosen to
implement automatic propagation of configurations across all the nodes in the cluster.

\subsection{Workload Management Systems}
